...
import tn.esprit.springfever.EventService;
import tn.esprit.springfever.Services.Implementation.ServiceNoteImpl;
...
public class SentimentTest {
    ...
    @Autowired
    private ServiceNoteImpl entityService;

    @MockBean
    private NoteRepository entityRepository;
